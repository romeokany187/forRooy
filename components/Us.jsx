        ...
        <div>
            <div className="bg-secondary px-[15rem] py-8 flex gap-9 ">
                <div className="w-[60%] ">
                    ...
                    <p className='text-white text-[1rem]  mb-2'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Animi tempore cupiditate perferendis dolor aliquid eveniet, culpa quasi nihil corporis ullam id autem at. Itaque tempora sed exercitationem quasi aliquam sit!</p>
                    <p className='text-white text-[1rem]  mb-2'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sit quas esse officiis quidem ipsum nemo.</p>
                ...
                <div className="grid grid-cols-[repeat(2,50%)] grid-rows-[repeat(2,43%)] gap-6 ">
                    <div className="flex flex-col justify-center items-center gap-3 bg-secondary py-4 px-4">
                        ...
                        <p className='text-[#cdcdcd] text-center text-[1rem]'>We bring the right peopl together  so challenge</p>
                    </div>
