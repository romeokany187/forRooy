            ...
            <div className="">
              <div className="w-full h-[80vh] flex flex-col justify-between ">
                  ...
                  <div className="">
                    ...
                    <div className="flex flex-col gap-2 uppercase ">
                      ...
                      <Link href="/"><div className="text-[#dce5e2] text-[1rem] cursor-pointer flex gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className="fill-white w-4">
                          <title>Mail</title>
                      ...
                      <Link href="/"><div className="text-[#dce5e2] text-[1rem] cursor-pointer flex gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-white w-4">
                ...
                <div className="flex justify-between content-between">
                  <p className="text-[#dce5e2] ">©2024 DanRooy studio</p>
